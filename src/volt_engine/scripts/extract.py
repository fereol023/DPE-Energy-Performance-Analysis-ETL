...
class DataEnedisAdemeExtractor(FileStorageConnexion):
    ...
    def __init__(self, debug=False):
        ...
        self.PATH_FILE_INPUT_ENEDIS_CSV = ""
        # --- objet debugger ---
        self.debug = debug
    ...
    def __load_batch_input(self):
        ...
        def load_enedis_input_from_local_csv():
            self.input_df = pd.read_csv(self.PATH_FILE_INPUT_ENEDIS_CSV, sep=';')
        ...
        try:
            ...
            assert self.input_df.shape[0] > 0, f"Erreur dans le chargement du fichier CSV input : {self.PATH_FILE_INPUT_ENEDIS_CSV}"
